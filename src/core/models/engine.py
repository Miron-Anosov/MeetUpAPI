...
from src.core.models.models.auth import AuthORM  # noqa
from src.core.models.models.base import BaseModel
from src.core.models.models.like import LikesORM  # noqa
from src.core.models.models.location import LocationORM  # noqa
from src.core.models.models.user import UserORM  # noqa
...
class HelperDB:
    ...
    _instance: Optional["HelperDB"] = None

    def __new__(cls, *args, **kwargs):
        """Create singleton API."""
        if cls._instance is None:
            cls._instance = super(HelperDB, cls).__new__(cls)
...
async def get_engine(url: str, echo: bool) -> "HelperDB":
    """Create ORM session/engine manager."""
    async with lock:
        manager = HelperDB(url=url, echo=echo)
